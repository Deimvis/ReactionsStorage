...
var GetAvailableReactions = ReadQueryFile("get_available_reactions.sql")
...
var GETReactions_GetEntityReactionsCount = ReadQueryFile("get_entity_reactions_count.sql")
var GetAllUserReactions = ReadQueryFile("get_all_user_reactions.sql")
